...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel sports = createHeader("SPORTS");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		quizPanel.add(sports);
    ...
    public void actionPerformed(ActionEvent e) {
		...
		if(buttonPressed == firstButton) {
			...
			askQuestion("What score is represented by the NBA? (all caps)", "BASKETBALL", 100);
			firstButton.setText("");
		}
		...
		if(buttonPressed == secondButton) {
			askQuestion("What score is represented by the NFL? (all caps)", "FOOTBALL", 200);
			secondButton.setText("");
			
		}
		if(buttonPressed == thirdButton) {
			askQuestion("What score is represented by FIFA? (all caps)", "SOCCER", 300);
			thirdButton.setText("");
			
		}
		if(buttonPressed == fourthButton) {
			askQuestion("What score is represented by the MLB? (all caps)", "BASEBALL", 400);
